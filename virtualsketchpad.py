...
cap.set(10,1000000) #increase brightness
ret = True
while ret:
    ...
    frame = cv2.rectangle(frame, (160,1), (255,65), (255,0,0), cv2.FILLED)
    frame = cv2.rectangle(frame, (275,1), (370,65), (0,255,0), cv2.FILLED)
    frame = cv2.rectangle(frame, (390,1), (485,65), (0,0,255), cv2.FILLED)
    frame = cv2.rectangle(frame, (505,1), (600,65), (0,255,255), cv2.FILLED)
